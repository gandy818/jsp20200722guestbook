...
/**
 * Servlet implementation class MesageDaoDeleteTestServlet
 */
@WebServlet("/MesageDaoDeleteTestServlet")
public class MesageDaoDeleteTestServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MesageDaoDeleteTestServlet() {
        super();
